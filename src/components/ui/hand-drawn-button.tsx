...
// Ensure the SVG filter runs on the client to avoid Next.js hydration mismatch
export const HandDrawnButton = ({ href, text }: Props) => {
  ...
  return (
    <>
      <a href={href} className="hand-drawn-btn">
