...
const DEFAULT_WORDS = ["OĞUZHAN", "TÜRKMEN", "DEVELOPER"]
...
export function ParticleTextEffect({ words = DEFAULT_WORDS }: ParticleTextEffectProps) {
  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    const newColor = {
      r: Math.random() * 100 + 155, // 155-255 arasý, çok karanlýk olmasýn
  ...
  const animate = () => {
    ...
    // Saydamlýðý artýrdým (motion blur için daha iyi), arkaplaný transparent yaptým (parent kontrol edecek)
